...
/**
 * Created by Brian_NB on 2016/5/24.
 */
public class appdefine {
    // handler message define.
    public static final int MSG_SHOW_CONNECTING = 0x10011;
    public static final int MSG_FINISH = 0x100012;
    public static final int MSG_CONNECTION_FAIL = 0x100013;
    public static final int MSG_CONNCETION_TIMEOUT = 0x100014;
    public static final int MSG_GET_DOMAIN = 0x100015;
