...
/**
 * Created by Brian_NB on 2016/6/22.
 */
public class TooltipWindow {
    ...
    public TooltipWindow(Context ctx) {
        ...
        TextView tvTiptext = (TextView) contentView.findViewById(R.id.tooltip_text);
        tvTiptext.setText(R.string.login_first_use_message);
        tvTiptext.setOnClickListener(new View.OnClickListener()
        {
